...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Giriş Onayı</a>
      ...
      <div class="row">
        <div class="col-lg-12 text-left align-left">          
          <form action="" method="POST" align="center">
			...
			<br>
			<br>
			    <center><img src="https://healthycities.zendesk.com/hc/en-us/article_attachments/209680108/Thumbs_down_icon_-_500px.png" alt=""/></center>
				<centet><p><b>Giriş başarısız bir şekilde gerçekleşmiştir. Kullanıcı adı veya Parola boş girilmiş olabilir. Yeniden şifre girişi yapınız.<b></p></center>
			</form>
        </div>
      </div>
    </div>
