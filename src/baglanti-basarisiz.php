...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Bağlantı Onayı</a>
        ...
        <div class="col-lg-12 text-left align-left">          
          <form action="" method="POST" align="center">
			...
			<br>
				...
				<centet><p><b>Bağlantı başarısız bir şekilde gerçekleşmiştir. Yorum göndermek için lütfen yeniden giriş yapınız.<b></p></center>
			</form>
        </div>
      </div>
    </div>
