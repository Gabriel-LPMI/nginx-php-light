      ...
      <div class="row">
        <div class="col-lg-12 text-left align-left">          
          <form action="" method="POST" align="center">
			...
			<br>
			<br>
			    <center><img src="http://www.smartoffice.com.tr/uploads/basarili.png" alt=""/></center>
				<centet><p><b>Bağlantı başarlı bir şekilde gerçekleşmiştir. Yorum göndermeye başlayabilirsiniz.<b></p></center>
			</form>
        </div>
      </div>
    </div>
